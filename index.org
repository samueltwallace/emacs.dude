...
*** TODO Write major mode for editing a buffer for window manager interaction (dired/org-style)
    ...
    I am running into some problems with this... Stumpwm doesn't expose enough useful functions to get a full desktop tree. Accessor functions are hidden, slot values as well... Not sure what the solution is.
