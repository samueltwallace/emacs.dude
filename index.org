...
#+BEGIN_SRC emacs-lisp
  (defun add-link-to-bib (file-location) (interactive "fFile:")
	(let (file-new-name (concat
				   (file-name-directory file-location)
				   (bibtex-key-in-head (bibtex-generate-autokey))))
       (bibtex-set-field "file" file-new-name)
       (rename-file file-location file-new-name)))
#+END_SRC
...
* Loading Packages and Setting Settings
